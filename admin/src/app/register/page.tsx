        ...
        <div className="pt-[120px] pb-[120px]">
          <div className="grid grid-cols-12 shadow-lg bg-white overflow-hidden rounded-md ">
            <div className="col-span-4 lg:col-span-6 relative h-full hidden lg:block">
              <div className="data-bg absolute top-0 left-0 w-full h-full bg-contain bg-no-repeat" data-bg="assets/img/bg/login-bg.png" style={{backgroundImage:`url(${register_bg.src})`}}></div>
            </div>
