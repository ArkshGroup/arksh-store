...
const award_data = [
  {
    id: "one",
    topic: "FREE SHIPPING",
    title: "Fast delivery on fashion orders",
    data_src: award_img_1,
    subtitle: "Enjoy quick shipping on clothes & shoes across Nepal.",
    delay: ".3s",
  },
  {
    id: "two",
    ...
    subtitle: "Simple return and exchange options if the fit isn't right.",
    delay: ".5s",
  },
  {
    id: "three",
    topic: "SECURE PAYMENT",
    title: "Safe checkout for every order",
    data_src: award_img_3,
    subtitle: "Your payments are protected with trusted gateways.",
    delay: ".7s",
  },
  {
    id: "four",
    topic: "PREMIUM QUALITY",
    title: "Carefully selected clothes & shoes",
    data_src: award_img_4,
    subtitle: "We curate quality styles for everyday wear and special occasions.",
    delay: ".7s",
  },
];
